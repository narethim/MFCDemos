	...
	CCreateContext* pContext)
{
	...
	if (!m_wndSplitter.CreateView(0, 0, RUNTIME_CLASS(CLeftView), CSize(150, 100), pContext) ||
		!m_wndSplitter.CreateView(0, 1, RUNTIME_CLASS(CSocketDemoServerView), CSize(100, 100), pContext))
	{
...
CSocketDemoServerView* CMainFrame::GetRightPane()
{
	CWnd* pWnd = m_wndSplitter.GetPane(0, 1);
	CSocketDemoServerView* pView = DYNAMIC_DOWNCAST(CSocketDemoServerView, pWnd);
	return pView;
}
...
void CMainFrame::OnUpdateViewStyles(CCmdUI* pCmdUI)
{
	...
	CSocketDemoServerView* pView = GetRightPane();
...
void CMainFrame::OnViewStyle(UINT nCommandID)
{
	...
	// if the right-hand pane has been created and is a CSocketDemoServerView,
